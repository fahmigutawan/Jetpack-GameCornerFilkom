...
class RepoReservasi {
    fun buatReservasi(
        ...
        val pickedDay = "${if(tanggal.toString().length == 1){
            "0${tanggal}"
        } else {
            tanggal
        ...
        firestore
            ...
            .whereEqualTo("nimPeminjam", repoOtentikasi.getNimMahasiswa())
            .whereIn(
                "pickedDay",
    ...
    fun getReservasiTerbaruForAdmin() = callbackFlow {
        ...
        FirebaseFirestore
            ...
            .whereIn("pickedDay", listDate.map {
                "${if(it.dayOfMonth.toString().length == 1){
                    "0${it.dayOfMonth}"
                } else {
                    it.dayOfMonth
                }}:${
                    if(it.monthValue.toString().length == 1){
                        "0${it.monthValue}"
                    } else {
                        it.monthValue
                    }
